...
public class Basics {
	...
	public static void main(String[] args) {
		...
		System.out.println(js.getString("place_id")); // added by mahi
		...
		System.out.println("exiting"); // added by mahi
	...
	// added by mahi
	public static  void sampletest11() {
		System.out.println("from the git learning session");
		System.out.println("i am resuming the work from develop branch");
	}
